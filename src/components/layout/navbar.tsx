...
export function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 px-5 sm:px-8 pointer-events-none">
            <div className={cn(
                "max-w-2xl mx-auto transition-all duration-700 ease-out pointer-events-auto",
                scrolled ? "mt-3" : "mt-5"
            )}>
                <nav className={cn(
                    ...
                    <Link href="/" className="flex items-center gap-2 shrink-0 group">
                        <span className="text-[15px] font-semibold tracking-[0.12em] text-[#1a1a1a] uppercase group-hover:text-black transition-colors">
                            Voila Cleaners
                        </span>
                    </Link>
